  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900 flex items-center justify-center p-8 relative overflow-hidden">
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          0%, 100% { box-shadow: 0 0 20px rgba(139, 92, 246, 0.5), 0 0 40px rgba(139, 92, 246, 0.3), inset 0 0 20px rgba(139, 92, 246, 0.2); }
          50% { box-shadow: 0 0 30px rgba(236, 72, 153, 0.6), 0 0 60px rgba(236, 72, 153, 0.4), inset 0 0 30px rgba(236, 72, 153, 0.3); }
        }
      ...
      <div className="relative z-10 flex flex-col items-center gap-8" style={{ animation: 'slideIn 0.8s ease-out' }}>
        ...
        <div className="text-center">
          <h1 className="text-7xl font-black mb-2 neon-text tracking-wider" style={{ fontFamily: 'Orbitron, sans-serif' }}>
            SNAKE<span className="text-pink-500">_</span>NEON
          </h1>
          <p className="text-purple-300 text-sm tracking-widest" style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 500 }}>
            ...
            <div className="relative" style={{ width: GRID_SIZE * CELL_SIZE, height: GRID_SIZE * CELL_SIZE }}>
              ...
              {gameOver && (
                <div className="absolute inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center rounded-lg">
                  <div className="text-center" style={{ animation: 'slideIn 0.5s ease-out' }}>
                    <div className="text-6xl font-black text-pink-500 mb-4 neon-text" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                      GAME OVER
                    </div>
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 neon-border"
              ...
              {isPaused && !gameOver && (
                <div className="absolute inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center rounded-lg">
                  <div className="text-5xl font-black text-purple-400 neon-text" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                    PAUSED
                  </div>
                </div>
              )}
